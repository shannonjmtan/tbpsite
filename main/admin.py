...
class SettingsAdmin(admin.ModelAdmin):
    list_display = ('__unicode__', 'term', 'display_all_terms', 'display_tutoring', 'registration_password')
    list_editable = ('term', 'display_all_terms', 'display_tutoring', 'registration_password')
